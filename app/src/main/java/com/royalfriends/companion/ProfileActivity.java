...
import com.royalfriends.companion.databinding.ActivityProfileBinding;
...
public class ProfileActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.selectImage.setOnClickListener(v -> Dexter.withActivity(ProfileActivity.this).withPermissions(Manifest.permission.READ_EXTERNAL_STORAGE).withListener(new MultiplePermissionsListener() {
            @Override
...
//                Intent intent = new Intent(Intent.ACTION_PICK);
        ...
        binding.submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (binding.Name.getEditableText().toString().isEmpty()) {
                    Toast.makeText(ProfileActivity.this, "Enter Your Crop Name", Toast.LENGTH_SHORT).show();
                } else if (binding.MobileNumber.getEditableText().toString().isEmpty()) {
                    Toast.makeText(ProfileActivity.this, "Enter Your MobileNumber", Toast.LENGTH_SHORT).show();
    ...
    private void upload() {
        ...
        storageReference = storage.getReference("UserProfileQuotes").child("" + MobileNumber);
