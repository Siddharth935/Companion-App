...
import com.royalfriends.companion.databinding.ActivityHappyBinding;
...
public class Happy extends AppCompatActivity {
    ...
    private ActivityHappyBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        reference = FirebaseDatabase.getInstance().getReference("Happy");
        binding.Happy.setLayoutManager(new LinearLayoutManager(Happy.this));
        binding.shimmer.startShimmer();

        list = new ArrayList<>();
        adaptor = new Adaptor(Happy.this, list);
        binding.Happy.setAdapter(adaptor);
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                binding.Happy.setVisibility(View.VISIBLE);
